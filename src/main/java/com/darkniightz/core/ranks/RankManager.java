...
public class RankManager {
    ...
    public RankManager(Plugin plugin) {
        ...
        if (ld == null || ld.isEmpty()) {
            ld = List.of("owner","developer","admin","srmod","moderator","helper","vip","builder","grandmaster","legend","diamond","gold","pleb");
        }
        ...
        String def = plugin.getConfig().getString("ranks.default", "pleb");
    ...
    private RankStyle fallbackStyle(String group) {
        ...
        switch (g) {
            ...
            case "friend":
                return RankStyle.colored("§7§lPLEB", "§7", false);
            case "builder":
                return RankStyle.colored("§9§lBUILDER", "§9", false);
            case "gold":
                return RankStyle.colored("§6§lGOLD", "§6", false);
            case "diamond":
                return RankStyle.colored("§b§lDIAMOND", "§b", false);
            case "legend":
                return RankStyle.colored("§d§lLEGEND", "§d", false);
            case "grandmaster":
                return RankStyle.colored("§4§l✦GM✦", "§4", true);
            case "pleb":
                return RankStyle.colored("§7§lPLEB", "§7", false);
            default:
    ...
    public String normalizeGroup(String input) {
        ...
        if (s.equals("friend")) return ladderContains("pleb") ? "pleb" : defaultGroup;
        ...
        if (code != 0) {
            switch (code) {
                case 'd':
                    return ladderContains("pleb") ? "pleb" : defaultGroup;
                ...
                case 'e': // yellow -> supporter tier
                    if (ladderContains("gold")) return "gold";
                    break;
            }
        }
    ...
    public static final class RankStyle {
        ...
        public static RankStyle defaultStyle() {
            return colored("§7§lPLEB", "§7", false);
        }
    }
}
