...
public class DatabaseManager {
    ...
    public void connect() {
        ...
        try {
            ...
            lastConnectError = e.getMessage() == null ? e.getClass().getSimpleName() : e.getMessage();
            dataSource = null;
        }
    }
    ...
    public boolean canAcquireConnection() {
        if (!ensureConnected()) {
            return false;
        }
        try (Connection ignored = dataSource.getConnection()) {
            ...
            lastConnectError = ex.getMessage() == null ? ex.getClass().getSimpleName() : ex.getMessage();
            return false;
        }
    }

    public String getLastConnectError() {
        return lastConnectError == null ? "" : lastConnectError;
    }
}
